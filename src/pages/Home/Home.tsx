...
const Home = () => {
  ...
  return (
    <>
      <main>
        <div
          className="relative pt-16 pb-32 flex content-center items-center justify-center font-roboto"
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div>
                  <h1 className="text-white font-bold text-5xl uppercase">
                    Feel The <span className="text-orange-500">GYM</span>
                  </h1>
                  <p className="mt-4 text-lg text-gray-300">
                    Welcome to The Gym Room. We are a fitness and training
        ...
        <section
          id="about"
          className="relative py-20 bg-black text-white font-roboto"
        >
        ...
        <section className="pb-20 relative block bg-black text-white">
          ...
          <div className="container mx-auto px-4 lg:pt-24 lg:pb-64 pb-20 pt-20 font-roboto">
        ...
        <section className="relative block py-24 lg:pt-0 bg-black font-roboto">
          <div className="container mx-auto px-4">
